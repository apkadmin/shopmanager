...
module.exports = {
	...
	settings: {
		...
		/** Public fields */
		fields: ["_id", "username", "email", "image","password","shop","role"],
			...
			handler(ctx) {
				...
				return this.Promise.resolve()
					...
					.then(() => {
						...
						return this.adapter.updateById(ctx.meta.user._id, {$set:{username:newData.username,updatedAt:newData.updatedAt,password:newData.password,email:newData.email}});
